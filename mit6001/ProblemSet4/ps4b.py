...
def compChooseWord(hand, wordList, n):
    ...
    for word in wordList:
        ...
        if cnt%ten_percent == 0:
            print str(cnt/ten_percent*10) + "% Done. "
...
def compPlayHand(hand, wordList, n):
    ...
    while len(hand) != 0:
        ...
        # run out of possible words, game over
        if not word:
            break
...
def chooseWhoToPlay(hand, wordList, n):
    while True:
...
def playGame(wordList):
    ...
    while True:
        ...
        if opt == "e":
            ...
            hand = dealHand(n)
            chooseWhoToPlay(hand, wordList, n)
        elif opt == "r":
            if not hand:
