...
“AI workslop” usually means low-value work produced with too much AI and too little human judgment.
...
mass-produced AI-generated text, code, art, or documents
content that looks finished but is shallow, repetitive, or error-prone
work created mainly to save effort, not to ensure quality
Examples:

copied AI summaries with no fact-checking
autogenerated code pasted in without understanding
long documents filled with vague AI wording
In short: AI is doing most of the production, but the result is bloated, careless, or low quality.
