    ...
    public class AppTestModelsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var appTestModel = await _context.AppTestModel
                .FirstOrDefaultAsync(m => m.AppTestInput == id);
        ...
        public async Task<IActionResult> Create([Bind("AppTestInput")] AppTestModel appTestModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AppTestInput")] AppTestModel appTestModel)
        {
            if (id != appTestModel.AppTestInput)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!AppTestModelExists(appTestModel.AppTestInput))
                    {
                        return NotFound();
                    }
                    else
        ...
        private bool AppTestModelExists(string id)
        {
            return _context.AppTestModel.Any(e => e.AppTestInput == id);
        }
    }
}
